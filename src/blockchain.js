    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                reject(`Error on finding a block with the given hash`);
            }
        });
    }
    ...
    validateChain() {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            self.chain.forEach((block)=>{
                if (!block.validate()) {
                    errorLog.push({type: "validation error", block});
                }
                if (previousHash && previousHash !== block.previousBlockHash) {
                    errorLog.push({type: "previousBlockHash error", block});
                }
